...
#ifdef HELTEC_MESH_NODE_T114
    // FF Kladow pager: restrict UI to critical faults, text messages and the system/debug
    // frame. Re-applied on every rebuild so menu toggles cannot re-enable hidden frames.
